...
<div class="wrap cricrm-admin-wrapper">
    <div class="bg-white rounded-lg shadow-md p-6 max-w-7xl mx-auto mt-5">
        ...
        <?php if ($is_admin) : ?>
            ...
            <div class="mb-6 border-b border-gray-200">
                <nav class="-mb-px flex space-x-8" aria-label="Tabs">
                    ...
                    <button type="button" class="cricrm-tab-btn border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm" data-target="tab-registry">
                        👥 Volontari
                    </button>
            ...
            <div id="tab-overview" class="cricrm-tab-content">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    ...
                    <div class="bg-blue-50 border-l-4 border-blue-500 p-4 rounded shadow-sm">
                        ...
                        <a href="#" onclick="document.querySelector('[data-target=\'tab-registry\']').click(); return false;" class="text-sm text-blue-600 hover:underline mt-2 inline-block">Gestisci Utenti &rarr;</a>
                    </div>
                    <!-- ... existing cards ... -->
        ...
        <!-- === TAB: REGISTRY (Admin Only) === -->
        <?php if ($is_admin) : ?>
            <div id="tab-registry" class="cricrm-tab-content hidden">
                <div class="bg-white border rounded-lg shadow-sm overflow-hidden">
                    <div class="bg-gray-50 px-6 py-4 border-b flex justify-between items-center">
                        <h3 class="font-bold text-gray-700 text-lg">👥 Gestione Volontari</h3>
                        <input type="text" id="reg-search" class="text-sm border rounded p-2 w-64" placeholder="Cerca volontario...">
                    </div>
                        ...
                        $('.reg-tags-input').on('change', function() {
                            ...
                            $.ajax({
                                ...
                                success: function() {
                                    ...
                                    // Update search data attr just in case
                                    // (Complex to update parent data-search without re-rendering, but minor issue)
                                },
                                error: function() {
